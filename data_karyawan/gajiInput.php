...
<body>
  ...
  <div class="form">
    <div class="containera">
      <div class="title">Input Data Gaji</div>
      <div class="content">
        <form action="gajiAksi.php" name="FinputGaji" method="POST">
          <div class="user-details">
            ...
            <div class="input-box">
              ...
              <input type="number" placeholder="Masukkan Jumlah Gaji" name="jumlah_gaji" min="0" step="any" required>
            </div>
          </div>
          <div class="button">
