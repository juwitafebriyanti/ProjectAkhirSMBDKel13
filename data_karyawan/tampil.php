...
<div class="container">
		...
		<div class="table-container">
            <div class="button-container">
                <a href="detail_karyawan.php" class="detail-button">Detail</a>
				<a href="form_input.php" class="detail-button">Tambah Data</a>
            </div>
        ...
        <table style="margin-left: auto;margin-right: auto;" border="1">
            <tr>
                ...
                <?php
                    include "koneksi.php";
                    $tampil=mysqli_query($koneksi,"SELECT * FROM KaryawanDepartemen");
                    while ($data=mysqli_fetch_array($tampil)) {
                ?>
            <tr>
                <td><?php echo $data['id_karyawan'] ?></td>
                <td><?php echo $data['nama_lengkap'] ?></td>
                <td><?php echo $data['id_departemen'] ?></td>
                <td><?php echo $data['id_jabatan'] ?></td>
                
                <td>
                    <a href="form_update.php?id_karyawan=<?php echo $data['id_karyawan']; ?>">Edit</a> | 
                    <a href="hapus.php?id_karyawan=<?php echo $data['id_karyawan']; ?>">Hapus</a>
                </td>
            </tr>
                <?php
                    }
