...
<body>
    ...
    <div class="containera">
      <div class="title">Input Data Jabatan</div>
      <div class="content">
        <form action="jabatanInputAksi.php" method="POST">
          <div class="user-details">
            <div class="input-box">
              <span class="details">ID Jabatan</span>
              <input type="text" name="id_jabatan" placeholder="Masukkan ID Jabatan" required>
            </div>
            <div class="input-box">
          ...
          <div class="button">
            ...
            <input type="reset" value="Batal" onclick="window.location.href='jabatan.php'">
          </div>
        </form>
      </div>
    </div>
