...
<head>
  <meta charset="utf-8">
    <title>Tampilan Data Departemen</title>
    <style type="text/css">
...
<body>
  <header>
    ...
    <center><h1>DATA DEPARTEMEN</h1></center>
    <div class="table-container">
    <div class="button-container">
        <a href="departemenDetail.php" class="detail-button">Detail</a>
        <a href="departemenInput.php" class="detail-button">Tambah Data</a>
    </div>
  <table style="margin-left: auto;margin-right: auto;" border="1">
    <tr>
      ...
      <?php
        include "koneksi.php";
        $tampil=mysqli_query($koneksi,"CALL jumlah_karyawan_per_departemen()");
